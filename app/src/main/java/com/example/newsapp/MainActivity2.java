                ...
                if(user.equals("")||pass.equals("")||repass.equals(""))
                    ...
                    if(pass.equals(repass)){
                        ...
                        if(checkuser==false){
                            ...
                            if(insert==true){
                                Toast.makeText(MainActivity2.this, "Registerted Successfully", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(MainActivity2.this, "User already exists!!please sigin ", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
